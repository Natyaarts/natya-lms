...
export default function AdminLayout({
  ...
  const icons = {
    ...
    payouts: <svg xmlns="http://www.w3.org/2000/svg" width="16" height="16" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round"><path d="M17 8V5a2 2 0 0 0-2-2H5a2 2 0 0 0-2 2v11a2 2 0 0 0 2 2h1"/><rect width="16" height="12" x="7" y="8" rx="2"/><path d="M13 12v4"/><path d="M11 14h4"/></svg>,
    ...
    orders: <svg xmlns="http://www.w3.org/2000/svg" width="16" height="16" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round"><circle cx="8" cy="21" r="1"/><circle cx="19" cy="21" r="1"/><path d="M2.05 2.05h2l2.66 12.42a2 2 0 0 0 2 1.58h9.78a2 2 0 0 0 1.95-1.57l1.65-7.43H5.12"/></svg>,
    subscriptionPlans: <svg xmlns="http://www.w3.org/2000/svg" width="16" height="16" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round"><path d="M12 2v4"/><path d="m16.24 7.76 2.83-2.83"/><path d="M18 12h4"/><path d="m16.24 16.24 2.83 2.83"/><path d="M12 18v4"/><path d="m4.93 19.07 2.83-2.83"/><path d="M2 12h4"/><path d="m4.93 4.93 2.83 2.83"/></svg>,
    refunds: <svg xmlns="http://www.w3.org/2000/svg" width="16" height="16" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round"><path d="M9 14 4 9l5-5"/><path d="M4 9h10.5a5.5 5.5 0 0 1 5.5 5.5v0a5.5 5.5 0 0 1-5.5 5.5H11"/></svg>,
    invoices: <svg xmlns="http://www.w3.org/2000/svg" width="16" height="16" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round"><path d="M4 2h11l5 5v13a2 2 0 0 1-2 2H4a2 2 0 0 1-2-2V4a2 2 0 0 1 2-2Z"/><path d="M14 2v6h6"/><path d="M9 13h6"/><path d="M9 17h6"/></svg>,
    teachersMentors: <svg xmlns="http://www.w3.org/2000/svg" width="16" height="16" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round"><circle cx="12" cy="8" r="5"/><path d="M20 21a8 8 0 0 0-16 0"/><path d="m16 11 2 2 4-4"/></svg>,
    assignments: <svg xmlns="http://www.w3.org/2000/svg" width="16" height="16" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round"><rect width="8" height="4" x="8" y="2" rx="1"/><path d="M16 4h2a2 2 0 0 1 2 2v14a2 2 0 0 1-2 2H6a2 2 0 0 1-2-2V6a2 2 0 0 1 2-2h2"/><path d="m9 14 2 2 4-4"/></svg>,
    certificates: <svg xmlns="http://www.w3.org/2000/svg" width="16" height="16" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round"><circle cx="12" cy="8" r="6"/><path d="M15.477 12.89 17 22l-5-3-5 3 1.523-9.11"/></svg>,
    subscriptions: <svg xmlns="http://www.w3.org/2000/svg" width="16" height="16" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round"><path d="m17 2 4 4-4 4"/><path d="M3 11v-1a4 4 0 0 1 4-4h14"/><path d="m7 22-4-4 4-4"/><path d="M21 13v1a4 4 0 0 1-4 4H3"/></svg>,
    earnings: <svg xmlns="http://www.w3.org/2000/svg" width="16" height="16" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round"><path d="M12 2v20"/><path d="M17 5H9.5a3.5 3.5 0 0 0 0 7h5a3.5 3.5 0 0 1 0 7H6"/></svg>,
  ...
  // Full Admin/Super Admin gets a sectioned nav (Custom Admin Dashboard
  // Completion phase's target structure); Teacher/Mentor keep their
  // existing narrower flat list, unchanged.
    ...
    ? [
        {
          ...
          links: [
            ...
            { name: "Teachers/Mentors", href: "/admin/teachers-mentors", icon: icons.teachersMentors },
            { name: "Courses", href: "/admin/courses", icon: icons.courses },
            { name: "Live Classes", href: "/admin/live-classes", icon: icons.liveClasses },
            { name: "Assignments", href: "/admin/assignments", icon: icons.assignments },
            { name: "Certificates", href: "/admin/certificates", icon: icons.certificates },
          ],
        },
        {
          title: "Commerce",
        ...
        },
        {
          title: "Finance",
          links: [
            { name: "Earnings", href: "/admin/earnings", icon: icons.earnings },
            { name: "Payouts", href: "/admin/payouts", icon: icons.payouts },
            { name: "Reconciliation", href: "/admin/reconciliation", icon: icons.reconciliation },
          ],
        },
        {
          title: "Communication",
          links: [
            { name: "Notifications", href: "/admin/notifications", icon: icons.notifications },
          ],
        },
        {
          title: "Operations",
    ...
    ? [
        {
          ...
          links: [
            ...
            { name: "Live Classes", href: "/admin/live-classes", icon: icons.liveClasses },
            { name: "Availability", href: "/admin/availability", icon: icons.availability },
            { name: "My Earnings", href: "/admin/my-earnings", icon: icons.payouts },
          ],
        },
      ]
    : isMentor
